...
class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://josmislas.devcamp.space/portfolio/portfolio_items",
      apiAction: "post",
    };
  ...
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://josmislas.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
        ...
        <div className="image-uploaders">
          {this.state.thumb_image_url && this.state.editMode ? (
            <div className="portfolio-manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a href onClick={() => this.deleteImage("thumb_image")}>
                  Remove file
                </a>
              </div>
            </div>
          ...
          {this.state.banner_image_url && this.state.editMode ? (
            <div className="portfolio-manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a href onClick={() => this.deleteImage("banner_image")}>
                  Remove file
                </a>
              </div>
            </div>
          ...
          {this.state.logo_url && this.state.editMode ? (
            <div className="portfolio-manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a href onClick={() => this.deleteImage("logo")}>
                  Remove file
                </a>
              </div>
            </div>
